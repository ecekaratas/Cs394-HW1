package com.example.recyclerviewexinclass.authentication
...
import com.example.recyclerviewexinclass.databinding.FragmentCreateAccountBinding
import com.example.recyclerviewexinclass.databinding.FragmentEmailPwBinding
    ...
    private fun createAccount(email: String, password: String, name: String) {
        ...
        auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(requireActivity()) { task ->
            if (task.isSuccessful) {
                ...
                this.findNavController().navigate(R.id.action_createAccountFragment_to_emailPasswordFragment)
            } else {
